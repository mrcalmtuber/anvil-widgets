...
export function ShortcutsWidget({ delay = 0, onRemove }: { delay?: number; onRemove?: () => void }) {
  const shortcuts = [
    ...
    { label: "Focus Mode", color: "bg-[#BF5AF2]", icon: "M12 22a10 10 0 1 0 0-20 10 10 0 0 0 0 20z M12 18a6 6 0 1 0 0-12 6 6 0 0 0 0 12z" },
    { label: "Morning", color: "bg-[#FF375F]", icon: "M12 2v2M12 20v2M4.93 4.93l1.41 1.41M17.66 17.66l1.41 1.41M2 12h2M20 12h2M6.34 17.66l-1.41 1.41M19.07 4.93l-1.41 1.41" }
  ];
